...
void MarlinSettings::reset() {
  ...
  planner.settings.min_travel_feedrate_mm_s = feedRate_t(DEFAULT_MINTRAVELFEEDRATE);
    ...
    home_offset.reset();
      ...
      //#if (EXTRUDERS > 1)
        float tmp[EXTRUDERS] = HOTEND_OFFSET_X;
        home_offset[0] = -(tmp[EXTRUDERS - 1]);//specifically for mightyboard with more than one extruder.
      //#endif
    #endif
  #endif
  ...
  #if PREHEAT_COUNT
    #if HAS_HOTEND
      constexpr uint16_t hpre[] = ARRAY_N(PREHEAT_COUNT, PREHEAT_1_TEMP_HOTEND, PREHEAT_2_TEMP_HOTEND, PREHEAT_3_TEMP_HOTEND, PREHEAT_4_TEMP_HOTEND, PREHEAT_5_TEMP_HOTEND, PREHEAT_6_TEMP_HOTEND, PREHEAT_7_TEMP_HOTEND);
    #endif
    #if HAS_HEATED_BED
      constexpr uint16_t bpre[] = ARRAY_N(PREHEAT_COUNT, PREHEAT_1_TEMP_BED, PREHEAT_2_TEMP_BED, PREHEAT_3_TEMP_BED, PREHEAT_4_TEMP_BED, PREHEAT_5_TEMP_BED, PREHEAT_6_TEMP_BED, PREHEAT_7_TEMP_BED);
    #endif
    #if HAS_FAN
      constexpr uint8_t fpre[] = ARRAY_N(PREHEAT_COUNT, PREHEAT_1_FAN_SPEED, PREHEAT_2_FAN_SPEED, PREHEAT_3_FAN_SPEED, PREHEAT_4_FAN_SPEED, PREHEAT_5_FAN_SPEED, PREHEAT_6_FAN_SPEED, PREHEAT_7_FAN_SPEED);
    #endif
