...
void Temperature::lcd_preheat(const int16_t e, const int8_t indh, const int8_t indb) {
  ...
  void menu_preheat_m(const uint8_t m) {
    ...
    #if HOTENDS == 1
      PGM_P msg_preheat[] = ARRAY_N(PREHEAT_COUNT, GET_TEXT(MSG_PREHEAT_1), GET_TEXT(MSG_PREHEAT_2), GET_TEXT(MSG_PREHEAT_3), GET_TEXT(MSG_PREHEAT_4), GET_TEXT(MSG_PREHEAT_5), GET_TEXT(MSG_PREHEAT_6), GET_TEXT(MSG_PREHEAT_7));
      #if HAS_HEATED_BED
        PGM_P msg_preheat_end[] = ARRAY_N(PREHEAT_COUNT, GET_TEXT(MSG_PREHEAT_1_END), GET_TEXT(MSG_PREHEAT_2_END), GET_TEXT(MSG_PREHEAT_3_END), GET_TEXT(MSG_PREHEAT_4_END), GET_TEXT(MSG_PREHEAT_5_END), GET_TEXT(MSG_PREHEAT_6_END), GET_TEXT(MSG_PREHEAT_7_END));
      #endif
    #elif HAS_MULTI_HOTEND
      PGM_P msg_preheat_all[] = ARRAY_N(PREHEAT_COUNT, GET_TEXT(MSG_PREHEAT_1_ALL), GET_TEXT(MSG_PREHEAT_2_ALL), GET_TEXT(MSG_PREHEAT_3_ALL), GET_TEXT(MSG_PREHEAT_4_ALL), GET_TEXT(MSG_PREHEAT_5_ALL), GET_TEXT(MSG_PREHEAT_6_ALL), GET_TEXT(MSG_PREHEAT_7_ALL));
    #endif

    #if HAS_TEMP_HOTEND && HAS_HEATED_BED && HAS_MULTI_HOTEND
      PGM_P msg_preheat_end_e[] = ARRAY_N(PREHEAT_COUNT, GET_TEXT(MSG_PREHEAT_1_END_E), GET_TEXT(MSG_PREHEAT_2_END_E), GET_TEXT(MSG_PREHEAT_3_END_E), GET_TEXT(MSG_PREHEAT_4_END_E), GET_TEXT(MSG_PREHEAT_5_END_E), GET_TEXT(MSG_PREHEAT_6_END_E), GET_TEXT(MSG_PREHEAT_7_END_E));
    #endif

    #if HAS_MULTI_HOTEND
      PGM_P msg_preheat_h[] = ARRAY_N(PREHEAT_COUNT, GET_TEXT(MSG_PREHEAT_1_H), GET_TEXT(MSG_PREHEAT_2_H), GET_TEXT(MSG_PREHEAT_3_H), GET_TEXT(MSG_PREHEAT_4_H), GET_TEXT(MSG_PREHEAT_5_H), GET_TEXT(MSG_PREHEAT_6_H), GET_TEXT(MSG_PREHEAT_7_H));
    #endif
    ...
    #if HAS_HEATED_BED
      PGM_P msg_preheat_bed[] = ARRAY_N(PREHEAT_COUNT, GET_TEXT(MSG_PREHEAT_1_BEDONLY), GET_TEXT(MSG_PREHEAT_2_BEDONLY), GET_TEXT(MSG_PREHEAT_3_BEDONLY), GET_TEXT(MSG_PREHEAT_4_BEDONLY), GET_TEXT(MSG_PREHEAT_5_BEDONLY), GET_TEXT(MSG_PREHEAT_6_BEDONLY), GET_TEXT(MSG_PREHEAT_7_BEDONLY));
  ...
  void menu_preheat_m2() { menu_preheat_m(1); }
    ...
    void menu_preheat_m3() { menu_preheat_m(2); }
      ...
      void menu_preheat_m4() { menu_preheat_m(3); }
        ...
        #if PREHEAT_COUNT >= 6
            void menu_preheat_m6() { menu_preheat_m(5); }
            #if PREHEAT_COUNT >= 7
                void menu_preheat_m7() { menu_preheat_m(6); }
            #endif
        #endif
      #endif
    #endif
