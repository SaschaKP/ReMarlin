  ...
  void DGUSScreenVariableHandler::HandlePreheat(DGUS_VP_Variable &var, void *val_ptr) {
    ...
    switch (preheat_option) {
      ...
      case 3: // Preheat ASA
        ...
        break;
      case 4: // Preheat ABS
#if defined(PREHEAT_5_TEMP_HOTEND) && defined(PREHEAT_5_TEMP_BED)
        e_temp = PREHEAT_5_TEMP_HOTEND;
        TERN_(HAS_HEATED_BED, bed_temp = PREHEAT_5_TEMP_BED);
#endif
        break;

      case 5: // Preheat PVB
#if defined(PREHEAT_6_TEMP_HOTEND) && defined(PREHEAT_6_TEMP_BED)
        e_temp = PREHEAT_6_TEMP_HOTEND;
        TERN_(HAS_HEATED_BED, bed_temp = PREHEAT_6_TEMP_BED);
#endif
        break;

      case 6: // Preheat PC
#if defined(PREHEAT_7_TEMP_HOTEND) && defined(PREHEAT_7_TEMP_BED)
        e_temp = PREHEAT_7_TEMP_HOTEND;
        TERN_(HAS_HEATED_BED, bed_temp = PREHEAT_7_TEMP_BED);
#endif
        break;
